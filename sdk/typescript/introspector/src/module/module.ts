...
import { findModuleByExportedName, AST, CLIENT_GEN_FILE } from "../ast"
import type { ResolvedNodeWithSymbol } from "../ast"
import { ENUM_DECORATOR, OBJECT_DECORATOR } from "../utils/decorator"
import { DaggerEnum } from "./enum.js"
import type { DaggerEnumsBase } from "./enumBase.js"
import { DaggerEnumClass } from "./enumClass.js"
import { DaggerInterface } from "./interface.js"
import type { DaggerInterfaces } from "./interface.js"
import { DaggerObject } from "./object.js"
import type { DaggerObjectsBase } from "./objectBase.js"
...
export class DaggerModule {
  ...
  private resolveReferences(references: string[]) {
    ...
    for (const reference of references) {
      ...
      throw new Error(`could not resolve type reference for ${reference}.`)
    }
  }
